...
import AgentsEventViewer from "../views/right_panel/AgentsEventViewer";
...
export default class RightPanel extends React.Component<Props, IState> {
    ...
    public render(): React.ReactNode {
        ...
        switch (phase) {
            ...
            case RightPanelPhases.AgentsEventViewer:
                if (!!this.props.room) {
                    card = <AgentsEventViewer room={this.props.room} onClose={this.onClose} />;
                }
                break;
        }
